...
- [ ] - Verificar se tipo de variável ou valor literal retornado é igual ao da função;
- [ ] - Comparar inteiro com booleano (e analisar se operadores fazem sentido para o tipo. Ex: boolean > boolean);
